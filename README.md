...
- big on RAG that actually cites its sources instead of making things up
...
`Python` `FastAPI` `LangChain` `LangGraph` `pgvector` `Docker` `AWS`

[LinkedIn](https://www.linkedin.com/in/niharika-khopade) · [niharika.g.khopade@gmail.com](mailto:niharika.g.khopade@gmail.com)
